...
// Page table address extraction
#define PT_ADDR_MASK 0x000FFFFFFFFFF000ULL

// Current PML4 (Page Map Level 4) pointer
static pte_t* pml4 = NULL;

// Helper: Get CR3 register (current page table base)
...
// Helper: Set CR3 register (load new page table)
static inline void set_cr3(uint64_t cr3) {
    __asm__ volatile("mov %0, %%cr3" :: "r"(cr3));
}

// Helper: Allocate a page table
