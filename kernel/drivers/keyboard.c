...
// Maximum scancode supported (covers standard keyboard scancodes)
#define MAX_SCANCODE 96

// US QWERTY keyboard scancode to ASCII mapping (scancode set 1)
// Index is the scancode, value is the ASCII character
static const char scancode_to_ascii_map[MAX_SCANCODE] = {
...
static const char scancode_to_ascii_shifted[MAX_SCANCODE] = {
    0,    27,  '!',  '@',  '#',  '$',  '%',  '^',  '&',  '*',  '(',  ')',  '_',  '+', '\b', '\t',
    'Q', 'W',  'E',  'R',  'T',  'Y',  'U',  'I',  'O',  'P',  '{',  '}', '\n',    0,  'A',  'S',
    'D', 'F',  'G',  'H',  'J',  'K',  'L',  ':', '\"',  '~',    0,  '|',  'Z',  'X',  'C',  'V',
    'B', 'N',  'M',  '<',  '>',  '?',    0,  '*',    0,  ' ',    0,    0,    0,    0,    0,    0,
